...
data<-read.csv("mosquito_data.csv")
tags$h1("NEON Mosquito collection Index")

ui<- fluidPage(
  fluidRow(
  column(6, offset = 3, tags$h1("NEON Mosquito Lookup", align="center"),
               tags$p("This tool combines data from",
               tags$a(href="https://data.neonscience.org/taxonomic-lists","NEON taxonomy tables"),
               ",", tags$a(href="https://biorepo.neonscience.org/portal/collections/misc/collprofiles.php?collid=29", "specimen records"),
               ", and storage maps for the physical pinned collection.")
         ,align="center")
    ),
  fluidRow(  
    column(4, offset = 4,
              tags$p(tags$a(href="https://mandrewj.shinyapps.io/neonbet/","NEON Carabid Lookup"))
           ,align="center")
  ),
  fluidRow(
    column(4, offset = 4,
                             
               textInput(inputId = "taxon", label = "Input taxon name:", value ="", width = '400px', placeholder = "Culicidae"),
